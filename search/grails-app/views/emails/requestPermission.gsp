...
<ol>
<li>click THIS link, which will ask you to log in to the system and manage this request</li>
<li>Select one of the following options:
<ul>
<li>I don't want to approve this request, and please don't bother me again - (An administrator may subseqently authorize a user to edit this data
if they can demonstrate that they have a legitimate reason to do so).</li>
<li>I want to approve this request, and I'm happy to approve future requests</li>
<li>I want to approve this request, please make this user responsible for all future requests</li>
</li>
